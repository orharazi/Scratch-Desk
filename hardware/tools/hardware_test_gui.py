#!/usr/bin/env python3
"""
DEPRECATED: Hardware Test GUI
=============================

This file is maintained for backward compatibility only.
Please use the new Admin Tool instead:

    python3 admin_tool.py

The Admin Tool includes all the functionality of this hardware test GUI
plus additional features for safety rules management and system configuration.
"""
...
warnings.warn(
    "hardware/tools/hardware_test_gui.py is deprecated. "
    "Please use 'python3 admin_tool.py' from the project root instead. "
    "The Admin Tool includes all hardware testing features plus safety rules and configuration management.",
    DeprecationWarning,
    stacklevel=2
)
...
UltimateHardwareTestGUI = AdminToolGUI


# Original imports (kept for any external code that imports from here)
...
class _DeprecatedUltimateHardwareTestGUI:
...
def main():
    """Main function - launches the new Admin Tool"""
    print("\n" + "=" * 70)
    print("DEPRECATION NOTICE")
    print("=" * 70)
    print("This hardware test GUI has been replaced by the Admin Tool.")
    print("Please use: python3 admin_tool.py")
    print("=" * 70 + "\n")

    root = tk.Tk()
    app = AdminToolGUI(root)  # Uses the new Admin Tool
    root.mainloop()
