...
class TestSafetyDuringExecution:
    ...
    def test_safety_allows_move_y_when_row_marker_up(self):
        ...
        # Ensure row marker is up and line motor down (motor piston UP during lines — not involved)
        mock_hardware.row_marker_up()
        mock_hardware.row_motor_piston_up()  # Door is UP during lines operations
