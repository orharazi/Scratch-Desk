#!/usr/bin/env python3
"""
Test script to verify RS485 sensors are updating in the GUI.
...
def test_rs485_sensors():
    """Test RS485 sensor reading and GUI updates"""
    ...
    print("\n" + "="*60)
    print("RS485 MODBUS SENSOR GUI UPDATE TEST")
    print("="*60)
