#!/usr/bin/env python3
"""
Quick test script to verify multiplexer sensor reads
"""
...
def main():
    ...
    logger.info("Multiplexer Sensor Test", category="hardware")
    logger.info("="*60, category="hardware")
    ...
    logger.info("Monitoring multiplexer sensors for 30 seconds...", category="hardware")
