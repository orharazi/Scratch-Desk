...
HEBREW_TRANSLATIONS = {
    ...
    "Door Left Up": "דלת שמאל למעלה",
    "Door Left Down": "דלת שמאל למטה",
    "Door Right Up": "דלת ימין למעלה",
    "Door Right Down": "דלת ימין למטה",
    "Row Door": "סרגל עמודות",
    "Row Door Piston": "בוכנת סרגל עמודות",
    "Door Piston": "בוכנת דלת",
    "OPEN": "פתוח",
    "CLOSED": "סגור",
    ...
    "Line Motor (Both)": "סרגל שורות (שניהם)",
    "Line Marker Pressure": "ווסת לחץ סרגל שורות",
    "Line Marker Pressure Piston": "בוכנת ווסת לחץ סרגל שורות",
    "Soft Mark": "סימון רך",
    "Hard Mark": "סימון קשה",
    "Pressure": "ווסת לחץ סרגל שורות",
    "Pressure Up": "ווסת לחץ סרגל שורות למעלה",
    "Pressure Down": "ווסת לחץ סרגל שורות למטה",
    "Row Marker": "סמן עמודות",
    "Row Cutter": "חותך עמודות",
    "Row Motor": "סרגל עמודות",
    "Row Motor (Both)": "סרגל עמודות (שניהם)",
    "Row Motor Piston": "בוכנת סרגל עמודות",
    "Motor Piston": "בוכנת מנוע",
    ...
    "Homing cycle enable": "אפשר מחזור איפוס",
    "Homing direction invert mask": "מסכת היפוך כיוון איפוס",
    "Homing locate feed rate (mm/min)": "קצב הזנת איתור איפוס (מ״מ/דקה)",
    "Homing search seek rate (mm/min)": "קצב חיפוש איפוס (מ״מ/דקה)",
    "Homing switch debounce delay (ms)": "השהיית ניפוי רעש מתג איפוס (מילישניות)",
    "Homing switch pull-off distance (mm)": "מרחק התנתקות מתג איפוס (מ״מ)",
    ...
    "Row pattern validation failed: width ({actual}) != expected ({expected})": "אימות תבנית עמודות נכשל: רוחב ({actual}) != צפוי ({expected})",
    "Desk width exceeded: {actual}cm > {max}cm": "רוחב חורג מהשולחן: {actual} ס״מ > {max} ס״מ",
    "Desk height exceeded: {actual}cm > {max}cm": "גובה חורג מהשולחן: {actual} ס״מ > {max} ס״מ",
    ...
    "Program validation failed - cannot run": "אימות תוכנית נכשל - לא ניתן להריץ",
    "Paper width ({width}cm) exceeds surface ({available}cm)": "רוחב הנייר ({width} ס״מ) חורג מהמשטח ({available} ס״מ)",
    "Paper height ({height}cm) exceeds surface ({available}cm)": "גובה הנייר ({height} ס״מ) חורג מהמשטח ({available} ס״מ)",
    ...
    "Cannot change settings while program is stopped mid-execution. Reset first": "לא ניתן לשנות הגדרות בזמן שתוכנית עצורה באמצע ביצוע. יש לאפס קודם",
    "Cannot Save": "לא ניתן לשמור",
    ...
    "🔄 RESET": "🔄 אפס",
    "Ready": "מוכן",
    "Stopped - press Continue to resume from current step": "נעצר - לחץ המשך כדי להמשיך מהצעד הנוכחי",
    ...
    "multi_line": "שרטוט כפול",
    "Multi Line": "שרטוט כפול",
    "Multi Line:": "שרטוט כפול:",
    "Multi Line Mode": "מצב שרטוט כפול",
    "rows_double_margin_right": "שוליים כפולים ימין",
    "rows_double_margin_left": "שוליים כפולים שמאל",
    "Double Margin Right (cm):": "שוליים כפולים ימין (ס״מ):",
    "Double Margin Left (cm):": "שוליים כפולים שמאל (ס״מ):",
    "Enable middle lines between marked lines": "הפעל קווים אמצעיים בין קווים מסומנים",
    "Pressure UP": "לחץ למעלה",
    "Pressure DOWN": "לחץ למטה",
    ...
    "row_motor_piston": "בוכנת סרגל עמודות",
    ...
    "Start Homing Sequence": "התחל תהליך איפוס",
    "Paper Starting Point": "נקודת התחלה של הנייר",
    "Start X (cm):": "התחלה X (ס״מ):",
    "Start Y (cm):": "התחלה Y (ס״מ):",
    "Paper starting position saved: X={x}, Y={y}": "נקודת התחלה של הנייר נשמרה: X={x}, Y={y}",
    "Paper starting position updated.": ".נקודת התחלה של הנייר עודכנה",
    "Please enter valid numbers": "אנא הזן מספרים תקינים",
    ...
    "Homing cycle": "מחזור איפוס",
    "Homing dir invert": "היפוך כיוון איפוס",
    "Homing feed": "הזנת איפוס",
    "Homing seek": "חיפוש איפוס",
    "Homing debounce": "ניפוי רעש איפוס",
    "Homing pull-off": "התנתקות איפוס",
    ...
    "Homing cycle enable (boolean)": "אפשור מחזור איפוס (בוליאני)",
    "Homing feed rate (mm/min)": "קצב הזנת איפוס (מ״מ/דקה)",
    "Homing seek rate (mm/min)": "קצב חיפוש איפוס (מ״מ/דקה)",
    "Homing debounce (milliseconds)": "ניפוי רעש איפוס (מילישניות)",
    "Homing pull-off distance (mm)": "מרחק התנתקות איפוס (מ״מ)",
    ...
    "Homing all motors...": "מבצע איפוס לכל המנועים...",
    ...
    "Start Homing": "התחל איפוס",
    "Start complete homing sequence?": "להתחיל תהליך איפוס מלא?",
    "Starting homing sequence...": "מתחיל תהליך איפוס...",
    "Homing complete": "האיפוס הושלם",
    "Homing failed: {error}": "האיפוס נכשל: {error}",
    "Homing error: {error}": "שגיאת איפוס: {error}",

    # ============================================================================
    # HOMING DIALOG
    # ============================================================================
    "Homing in Progress": "איפוס בתהליך",
    "Homing in Progress...": "איפוס בתהליך...",
    "1. Apply GRBL configuration": "1. החלת הגדרות GRBL",
    "2. Lift row motor piston and verify up": "2. הרמת בוכנת סרגל עמודות ואימות שלמעלה",
    "3. Reset all pistons to default position": "3. איפוס כל הבוכנות למצב ברירת מחדל",
    "4. Lift line motor pistons": "4. הרמת בוכנות סרגל שורות",
    "5. Move Y axis (pre-home clearance)": "5. הזזת ציר Y (פינוי לפני איפוס)",
    "6. Run GRBL homing ($H)": "6. הפעלת איפוס GRBL ($H)",
    "6. Run GRBL homing ($H) (timeout: {timeout} seconds)": "6. הפעלת איפוס GRBL ($H) (זמן קצוב: {timeout} שניות)",
    "6. Run GRBL homing ($H) (remaining: {remaining} seconds)": "6. הפעלת איפוס GRBL ($H) (נותרו: {remaining} שניות)",
    "7. Reset work coordinates to (0,0)": "7. איפוס קואורדינטות עבודה ל-(0,0)",
    "8. Lower line motor pistons": "8. הורדת בוכנות סרגל שורות",
    "9. Verify all tool pistons UP": "9. אימות שכל הבוכנות למעלה",
    "Homing Failed": "האיפוס נכשל",
    "Homing failed!\n\nError: {error}\n\nTry again?": "האיפוס נכשל!\n\nשגיאה: {error}\n\nלנסות שוב?",
    "Homing sequence failed!\n\nError: {error}": "תהליך האיפוס נכשל!\n\nשגיאה: {error}",
    "Homing Complete": "האיפוס הושלם",
    "Homing sequence completed successfully!\n\nMachine is now at home position (0, 0).": "תהליך האיפוס הושלם בהצלחה!\n\nהמכונה נמצאת כעת במיקום בית (0, 0).",
    ...
    "Homing Required": "נדרש איפוס",
    "Real hardware mode is active.\n\nThe machine needs to be homed before operation.\nThis will:\n1. Apply GRBL configuration\n2. Lift row motor piston and verify up\n3. Lift line motor pistons\n4. Run GRBL homing ($H)\n5. Reset work coordinates\n6. Lower line motor pistons\n\nMake sure the machine is clear and ready.\n\nRun homing now?": "מצב חומרה אמיתית פעיל.\n\nיש לבצע איפוס למכונה לפני הפעלה.\nפעולה זו תבצע:\n1. החלת הגדרות GRBL\n2. הרמת בוכנת סרגל עמודות ואימות שלמעלה\n3. הרמת בוכנות סרגל שורות\n4. הפעלת איפוס GRBL ($H)\n5. איפוס קואורדינטות עבודה\n6. הורדת בוכנות סרגל שורות\n\nוודא שהמכונה פנויה ומוכנה.\n\nלהפעיל איפוס עכשיו?",
    "Machine was NOT homed.\n\nYou can run homing later from the Hardware Test GUI\nor by switching hardware modes in the settings panel.": "המכונה לא עברה איפוס.\n\nניתן להפעיל איפוס מאוחר יותר מממשק בדיקת החומרה\nאו על ידי החלפת מצב חומרה בלוח ההגדרות.",
    "Machine was NOT homed.\n\nYou must run homing before running any program.\nUse the homing button to run homing.": "המכונה לא עברה איפוס.\n\nיש לבצע איפוס לפני הפעלת תוכנית.\nהשתמש בכפתור האיפוס.",
    "Machine not homed! Run homing first": "המכונה לא עברה איפוס! יש לבצע איפוס קודם",
    "Cannot run program - machine has not been homed!\n\nYou must complete homing before running any program.\nUse the homing button to run homing.": "לא ניתן להריץ תוכנית - המכונה לא עברה איפוס!\n\nיש להשלים איפוס לפני הפעלת תוכנית.\nהשתמש בכפתור האיפוס.",

    # Manual homing confirmation
    "Run Homing": "הפעל איפוס מערכת",
    "Cannot Home": "לא ניתן לבצע איפוס",
    "Cannot run homing while a program is executing.\nStop execution first.": "לא ניתן לבצע איפוס בזמן שתוכנית רצה.\nעצור את הביצוע קודם.",
    ...
    "This will run the homing sequence.\n\nMake sure the machine is clear and ready.\n\nRun homing now?": "פעולה זו תפעיל את תהליך האיפוס.\n\nוודא שהמכונה פנויה ומוכנה.\n\nלהפעיל איפוס עכשיו?",

    # Homing status
    "HOMING": "איפוס",
    "Running homing sequence...": "מבצע תהליך איפוס...",
    ...
    "GRBL homing completed": "איפוס GRBL הושלם",
    ...
    "Move X-axis (rows motor) - horizontal movement": "הזז ציר X (סרגל עמודות) - תנועה אופקית",
    "Move Y-axis (lines motor) - vertical movement": "הזז ציר Y (סרגל שורות) - תנועה אנכית",
    ...
    "row_marker": "סמן עמודות",
    "row_cutter": "חותך עמודות",
    "line_motor": "סרגל שורות",
    "row_motor_limit_switch": "מתג גבול סרגל עמודות",
    ...
    "line_motor_left_up_sensor": "חיישן סרגל שורות שמאל למעלה",
    "line_motor_left_down_sensor": "חיישן סרגל שורות שמאל למטה",
    "line_motor_right_up_sensor": "חיישן סרגל שורות ימין למעלה",
    "line_motor_right_down_sensor": "חיישן סרגל שורות ימין למטה",
    ...
    "row_motor_left_up_sensor": "חיישן שמאל למעלה - סרגל עמודות",
    "row_motor_left_down_sensor": "חיישן שמאל למטה - סרגל עמודות",
    "row_motor_right_up_sensor": "חיישן ימין למעלה - סרגל עמודות",
    "row_motor_right_down_sensor": "חיישן ימין למטה - סרגל עמודות",
    ...
    "homing_poll_interval": "תדירות דגימת איפוס",
    ...
    "line_marker_pressure_piston": "בוכנת ווסת לחץ סרגל שורות",
    ...
    "line_marker_pressure_up_sensor": "חיישן ווסת לחץ סרגל שורות - למעלה",
    "line_marker_pressure_down_sensor": "חיישן ווסת לחץ סרגל שורות - למטה",
    ...
    "homing_timeout": "זמן המתנה לאיפוס",
    ...
    "$21": "גבולות קשיחים ($21)",
    "$22": "מחזור איפוס ($22)",
    "$23": "היפוך כיוון איפוס ($23)",
    "$24": "קצב הזנת איפוס ($24)",
    "$25": "קצב חיפוש איפוס ($25)",
    "$26": "ניפוי רעש איפוס ($26)",
    "$27": "מרחק התנתקות איפוס ($27)",
    ...
    # --- mock_hardware ---
    "homing_step_delay": "השהיית צעד איפוס",
    "piston_operation_delay": "השהיית פעולת בוכנה",
    "grbl_homing_delay": "השהיית איפוס GRBL",
