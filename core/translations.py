...
HEBREW_TRANSLATIONS = {
    ...
    "Row Door": "דלת עמודות",
    "Row Door Piston": "בוכנת דלת עמודות",
    ...
    "Row Motor Door (Both)": "דלת סרגל עמודות (שניהם)",
    "Row Motor Door Piston": "בוכנת דלת סרגל עמודות",
    ...
    "row_motor_door_piston": "בוכנת דלת סרגל עמודות",
    ...
    "2. Lift rows motor door piston": "2. הרמת בוכנת דלת סרגל עמודות",
    ...
    "Real hardware mode is active.\n\nThe machine needs to be homed before operation.\nThis will:\n1. Apply GRBL configuration\n2. Lift line motor pistons\n3. Run GRBL homing ($H)\n4. Reset work coordinates\n5. Lower line motor pistons\n\nMake sure the machine is clear and ready.\n\nRun homing now?": "מצב חומרה אמיתית פעיל.\n\nיש לבצע איפוס מערכת למכונה לפני הפעלה.\nפעולה זו תבצע:\n1. החלת הגדרות GRBL\n2. הרמת בוכנות סרגל שורות\n3. הפעלת איפוס מערכת GRBL ($H)\n4. איפוס קואורדינטות עבודה\n5. הורדת בוכנות סרגל שורות\n\nוודא שהמכונה פנויה ומוכנה.\n\nלהפעיל איפוס מערכת עכשיו?",
    ...
    "row_door_left_up_sensor": "חיישן שמאל למעלה - דלת עמודות",
    "row_door_left_down_sensor": "חיישן שמאל למטה - דלת עמודות",
    "row_door_right_up_sensor": "חיישן ימין למעלה - דלת עמודות",
    "row_door_right_down_sensor": "חיישן ימין למטה - דלת עמודות",
