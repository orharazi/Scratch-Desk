...
class CanvasSensors:
    ...
    def animate_pointer_to_sensor(self, axis, position):
        ...
        if self.canvas_manager.motor_operation_mode == "lines":
            ...
            x_label_color = "gray"
            y_label_text = rtl(f"\u05e9\u05d5\u05e8\u05d5\u05ea={pointer_y:.1f}cm (SENSOR)") if axis == 'y' else rtl(f"\u05e9\u05d5\u05e8\u05d5\u05ea={pointer_y:.1f}cm (ACTIVE)")
            y_label_color = "blue"
            ...
            motor_line_y = 0.0
            x_label_text = rtl(f"\u05e2\u05de\u05d5\u05d3\u05d5\u05ea={pointer_x:.1f}cm (SENSOR)") if axis == 'x' else rtl(f"\u05e2\u05de\u05d5\u05d3\u05d5\u05ea={pointer_x:.1f}cm (ACTIVE)")
            x_label_color = "red"
            ...
            motor_line_x = pointer_x
            motor_line_y = pointer_y
            x_label_text = rtl(f"\u05e2\u05de\u05d5\u05d3\u05d5\u05ea={pointer_x:.1f}cm") + (" (SENSOR)" if axis == 'x' else "")
            x_label_color = "red"
            y_label_text = rtl(f"\u05e9\u05d5\u05e8\u05d5\u05ea={pointer_y:.1f}cm") + (" (SENSOR)" if axis == 'y' else "")
            y_label_color = "blue"
    ...
    def update_sensor_position_display(self):
        ...
        if self.canvas_manager.motor_operation_mode == "lines":
            ...
            x_label_text = rtl("\u05e2\u05de\u05d5\u05d3\u05d5\u05ea=0.0cm (HOLD)")
            x_label_color = "gray"
            y_label_text = rtl(f"\u05e9\u05d5\u05e8\u05d5\u05ea={pointer_y:.1f}cm (SENSOR)")
            y_label_color = "blue"
            ...
            motor_line_x = pointer_x
            motor_line_y = 0.0
            x_label_text = rtl(f"\u05e2\u05de\u05d5\u05d3\u05d5\u05ea={pointer_x:.1f}cm (SENSOR)")
            x_label_color = "red"
            y_label_text = rtl("\u05e9\u05d5\u05e8\u05d5\u05ea=0.0cm (HOLD)")
            y_label_color = "gray"
